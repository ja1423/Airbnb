...
var _withScopeId = (n) => (pushScopeId("data-v-2ea569e3"), n = n(), popScopeId(), n);
...
var _hoisted_4 = ["onClick", "onDblclick"];
...
var _sfc_main = defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "239203e1": unref(tableMinHeightPx),
      "e83588a2": unref(tableHeightPx)
    }));
    const {
      clickEventType,
      bodyTextDirection,
...
var DataTable = _export_sfc(_sfc_main, [["__scopeId", "data-v-2ea569e3"]]);
